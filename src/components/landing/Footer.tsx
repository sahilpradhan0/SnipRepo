...
export function Footer() {
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8 items-center justify-center">
                        <div>
                            ...
                            <p className="text-sm -mt-2">
                                Your personal code library. Organize, search, and manage code snippets like a pro.
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li><Link to="/about" className="hover:text-gray-900 dark:hover:text-white transition">About</Link></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><Link to="/refund-cancellation" className="hover:text-gray-900 dark:hover:text-white transition">Refund & Cancellation</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col justify-between items-center">
                        <p className="text-sm">© 2025 SnipRepo. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        )
    ...
    return (
        <footer className="border-t border-gray-200 dark:border-gray-700 flex flex-col justify-between items-center p-8 bg-gray-100 dark:bg-gray-900">
